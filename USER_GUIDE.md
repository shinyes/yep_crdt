...
safeTimestamp := hlc.SubPhysical(currentTime, 5000) // 5000 毫秒 = 5 秒
...
同步协议与消息结构的稳定文档可直接查看：`docs/sync_protocol.md`、`docs/network_message.md`（由 `go run ./cmd/gen_sync_docs` 生成）。
